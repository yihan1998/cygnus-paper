...
Traditional kernel schedulers provides abundant scheduling policies but operate at millisecond timescales, unsuitable for modern applications.
...
Instead, they rigidly hardcode a hybrid policy by combining centralized First-Come-First-Served (FCFS) for light-tailed workload with Processor Sharing (PS) for heavy-tailed workloads.
