...
\newcommand{\kernel}{Mesokernel\xspace}
\newcommand{\gate}{Meso-Gate\xspace}
\newcommand{\downcallgate}{Downcall-Gate\xspace}
...
\title{The \kernel: Dataplane OS with Decentralized Microsecond-scale Preemption}
